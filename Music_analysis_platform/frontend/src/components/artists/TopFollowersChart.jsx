...
const TopFollowersChart = ({ data, onArtistSelect, selectedArtist }) => {
  ...
  return (
    <ChartCard
      title="Top 15 Most Followed Artists"
      subtitle="Sorted by followers (DESC) - click a bar to filter"
      data={chartData}
      height={420}
    >
            ...
            {chartData.map((entry) => {
              ...
              return (
                <Cell
                  ...
                  fill={isSelected ? 'url(#followersGradient)' : '#3A2617'}
